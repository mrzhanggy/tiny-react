...
```react
// 1 jsx 代码执行前会被转换为 React.createElement 的调用
React.createElement(
  "div",
  {
    className: "container"
...
// 2. createElement 返回 Virtual DOM 对象
// 3. 根据 Virtual DOM 生成真实的 DOM
```
...
<img src="src/images/1.png" style="margin: 20px 0;width: 80%"/>
...
<img src="src/images/2.png" width="50%"/>
...
<img src="src/images/3.png" width="50%"/>
...
<img src="src/images/8.png" width="80%" style="margin-bottom: 30px"/>
...
<img src="src/images/5.png" width="40%" align="left"/>
